...
const exto = {
  ...
  zkt:    {desc: 'Data Independent Execution Latency Subset', url: cryptoDoc + 'scalar/riscv-crypto-scalar-zkt.adoc'},
  ...
  zvknha:   {desc: 'Vector NIST SHA-256', url: fproxSubstack + 'risc-v-vector-cryptography-extensions'},
  zvknhb:   {desc: 'Vector NIST SHA-256 and SHA-512', url: fproxSubstack + 'risc-v-vector-cryptography-extensions'},
  zvkb:     {desc: 'Vector bit manipulations', url: fproxSubstack + 'risc-v-vector-cryptography-extensions'},
  ...
  zvkg:     {desc: 'Vector multiplication or accumulate-and-multiply for GHASH', url: fproxSubstack + 'risc-v-vector-cryptography-extensions'},
  zvkn:     {desc: 'Vector NIST Algorithm Suite (AES, SHA-256, SHA-512, Bitmanip)', url: fproxSubstack + 'risc-v-vector-cryptography-extensions'},
  zvks:     {desc: 'Vector Shang-Mi Algorithm Suite (SM4, SM3, Bitmanip)', url: fproxSubstack + 'risc-v-vector-cryptography-extensions'},
