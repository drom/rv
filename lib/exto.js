...
const exto = {
  ...
  zvkg:     {desc: 'Vector multiplication or accumulate-and-multiply for the GHASH', url: fproxSubstack + 'risc-v-vector-cryptography-extensions'},
  ...
  zvlsseg:  {desc: 'Vector segment load/stores supported (DEPRICATED)'}, // DEPRICATED
