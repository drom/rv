...
const exto = {
  ...
  sv:           {id: 's',         ver: 0,   desc: 'Page-based Virtual Memory Extension'}, // 32, 39, 48, 57
  ...
  sm:           {id: 'sm',        ver: 0,   desc: 'Machine Architecture'}, // 1.11, 1.12
  ss:           {id: 'sm',        ver: 0,   desc: 'Supervisor Architecture'}, // 1.11, 1.12, 1.13

  sstc:         {id: 'sstc',      ver: 0,   desc: 'Supervisor-mode Timer Interrupts'},
  sscofpmf:     {id: 'sscofpmf',  ver: 0.5, desc: 'Supervisor-level Count Overflow and Mode-Based Filtering'},

  smstateen:    {id: 'smstateen', ver: 0,   desc: 'Extension for State-enable'},

  svbare:       {id: 'svbare',       desc: 'Bare mode virtual-memory translation supported'},
  svade:        {id: 'svade',        desc: 'Raise exceptions on improper A/D bits'},
  ssccptr:      {id: 'ssccptr',      desc: 'Main memory supports page table reads'},
  sscounterenw: {id: 'sscounterenw', desc: 'Support writeable enables for any supported counter'},
  sstvecd:      {id: 'sstvecd',      desc: 'stvec supports Direct mode'},
  sstvala:      {id: 'sstvala',      desc: 'stval provides all needed values'},
  ssu64xl:      {id: 'ssu64xl',      desc: 'UXLEN=64 must be supported'},
  ssstateen:    {id: 'ssstateen',    desc: 'Supervisor-mode view of the state-enable extension'},
  shcounterenw: {id: 'shcounterenw', desc: 'Support writeable enables for any supported counter'},
  shvstvala:    {id: 'shvstvala',    desc: 'vstval provides all needed values'},
  shtvala:      {id: 'shtvala',      desc: 'htval provides all needed values'},
  shvstvecd:    {id: 'shvstvecd',    desc: 'vstvec supports Direct mode'},
  shvsatpa:     {id: 'shvsatpa',     desc: 'vsatp supports all modes supported by satp'},
  shgatpa:      {id: 'shgatpa',      desc: 'SvNNx4 mode supported for all modes supported by satp, as well as Bare'},
