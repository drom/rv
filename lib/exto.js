...
const exto = {
  ...
  zfh:    {ver: 1,               desc: 'Standard Extension for Half-Precision Floating-Point', url: fproxSubstack + 'riscv-zfh-half-support'}, // Ch.16
  zfhmin: {ver: 1,               desc: 'Standard Extension for Half-Precision Floating-Point', url: fproxSubstack + 'riscv-zfh-half-support'}, // Ch.16.6
  ...
  // Zc v1.0.2
  zc:     {ver: '1.0.2', desc: '', url: fproxSubstack + 'riscv-compressed-zc-extensions'},
  zcf:    {ver: 2.0,     desc: ''},
  zcd:    {ver: '1.0.2', desc: ''},
  zcb:    {ver: '1.0.2', desc: ''},
  zcmp:   {ver: '1.0.2', desc: ''},
