...
const rvvTraits = [
  {ch: '32.6',      m: /^v(?<a>set[i]?vl[i]?)$/,                    desc: 'Configuration-Setting Instructions (vsetvli/vsetivli/vsetvl)'},
  ...
  {ch: '32.15',     m: /^v\w+(?<c>.m(m?))$/,                        desc: 'Vector Mask Instructions'},

  {ch: '32.15.1',   m: /^v(?<a>m\w+[dnrvt]).m(m?)$/,                desc: 'Vector Mask-Register Logical Instructions'},
  {ch: '32.15.2',   m: /^(?<a>vcpop).m$/,                           desc: 'Vector count population in mask vcpop.m'},
  {ch: '32.15.3',   m: /^(?<a>vfirst).m$/,                          desc: 'vfirst find-first-set mask bit'},
  {ch: '32.15.4',   m: /^(?<a>vmsbf).m$/,                           desc: 'vmsbf.m set-before-first mask bit'},
  {ch: '32.15.5',   m: /^(?<a>vmsif).m$/,                           desc: 'vmsif.m set-including-first mask bit'},
  {ch: '32.15.6',   m: /^(?<a>vmsof).m$/,                           desc: 'vmsof.m set-only-first mask bit'},
  {ch: '32.15.8',   m: /^(?<a>viota).m$/,                           desc: 'Vector Iota Instruction'},
  {ch: '32.15.9',   m: /^(?<a>vid.v)$/,                             desc: 'Vector Element Index Instruction'},

  {ch: '32.16',     m: /^v[f]?mv(?<c>.[xsf].[xsf])$/,               desc: 'Vector Permutation Instructions'},

  {ch: '32.16.1',   m: /^v(?<a>mv.(x.s|s.x))$/,                     desc: 'Integer Scalar Move Instructions'},
  {ch: '32.16.2',   m: /^v(?<a>fmv.(f.s|s.f))$/,                    desc: 'Floating-Point Scalar Move Instructions'},

  {ch: '32.16.3',   m: /^v(?<a>slide)\w+.v[xi]$/,                   desc: 'Vector Slide Instructions'},
  {ch: '32.16.3.1', m: /^v(?<a>slideup).v[xi]$/,                    desc: 'Vector Slideup Instructions'},
  {ch: '32.16.3.2', m: /^v(?<a>slidedown).v[xi]$/,                  desc: 'Vector Slidedown Instructions'},
  {ch: '32.16.3.3', m: /^v(?<a>vslide1up).vx$/,                     desc: 'Vector Slide1up'},
  {ch: '32.16.3.4', m: /^v(?<a>vfslide1up).vf$/,                    desc: 'Vector Floating-Point Slide1up Instruction'},
  {ch: '32.16.3.5', m: /^v(?<a>vslide1down).vx$/,                   desc: 'Vector Slide1down Instruction'},
  {ch: '32.16.3.6', m: /^v(?<a>vfslide1down).vf$/,                  desc: 'Vector Floating-Point Slide1down Instruction'},

  {ch: '32.16.4',   m: /^v(?<a>rgather\w*).v[vxi]$/,                desc: 'Vector Register Gather Instructions'},
  {ch: '32.16.5',   m: /^v(?<a>compress).vm$/,                      desc: 'Vector Compress Instruction'},
  {ch: '32.16.6',   m: /^v(?<a>mv\dr).v$/,                          desc: 'Whole Vector Register Move'},
